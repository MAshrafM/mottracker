        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link to="/reports/active-motors" className="group flex flex-col items-center p-6 text-center
              ...
              <Activity className="w-12 h-12 mb-4 text-white opacity-70 transition-opacity group-hover:opacity-100" />
            ...
            <Link to="/reports/active-motors-detailed" className="group flex flex-col items-center p-6 text-center
                         bg-white/5 backdrop-blur-md rounded-xl 
                         border border-white/10 
                         shadow-lg transition-all duration-300 
                         hover:bg-white/20 hover:border-white/30 hover:shadow-xl">
              <Activity className="w-12 h-12 mb-4 text-emerald-400 opacity-70 transition-opacity group-hover:opacity-100" />
              <h3 className="text-xl font-semibold mb-2 text-white">Active Motor Detailed</h3>
            ...
            <Link to="/reports/spare-motors" className="group flex flex-col items-center p-6 text-center
                         ...
                         shadow-lg transition-all duration-300 
                         hover:bg-white/20 hover:border-white/30 hover:shadow-xl">
              <Archive className="w-12 h-12 mb-4 text-white opacity-70 transition-opacity group-hover:opacity-100" />
            ...
            <Link to="/reports/bearings" className="group flex flex-col items-center p-6 text-center
                         bg-white/5 backdrop-blur-md rounded-xl 
                         border border-white/10 
                         shadow-lg transition-all duration-300 
                         hover:bg-white/20 hover:border-white/30 hover:shadow-xl">
              <Disc className="w-12 h-12 mb-4 text-white opacity-70 transition-opacity group-hover:opacity-100" />
            ...
            <Link to="/reports/motor-maintenance" className="group flex flex-col items-center p-6 text-center
                         ...
                         shadow-lg transition-all duration-300 
                         hover:bg-white/20 hover:border-white/30 hover:shadow-xl">
              <ClipboardList className="w-12 h-12 mb-4 text-white opacity-70 transition-opacity group-hover:opacity-100" />
            ...
            <Link to="/reports/unit-motor" className="group flex flex-col items-center p-6 text-center
                         bg-white/5 backdrop-blur-md rounded-xl 
                         border border-white/10 
                         shadow-lg transition-all duration-300 
                         hover:bg-white/20 hover:border-white/30 hover:shadow-xl">
